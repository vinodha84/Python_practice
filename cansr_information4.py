...
#cansr info 4/4
cansr_info=driver.find_element_by_xpath("//body/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[2]/section[3]/div[1]/div[1]/ul[1]/li[4]")
cansr_info.click()
time.sleep(3)

Q9=driver.find_element_by_xpath("//textarea[@id='related_comment']")
Q9.send_keys('Contiune with same treatment')
time.sleep(3)
